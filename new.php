...
<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST') { //part 1 
    $name = $_POST['name'];
...
<body background="./assets/background.jpg">
    <a id="left-link" href="form.php" target="_blank">Add member(POST METHOD)</a><br> <!-- POST METHOD FORM -->
    <a id="left-link" href="form2.php" target="_blank">Add member(GET METHOD)</a><!-- GET METHOD FORM -->
    <div class="container">
        <div class="left-side">
        ...
        <div class="right-side">
            ...
            <div class="mycard">
                ...
                <div class="card" onclick="updateLeftSide('<?php echo $imageDestPath; ?>', '<?php echo $name; ?>', '<?php echo $linkedIn; ?>', '<?php echo $motto; ?>')">
    <div class="card-image">
        <img src="<?php echo $imageDestPath; ?>" alt="Profile image">
    </div>
